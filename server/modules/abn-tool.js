...
async function scrapeABNDetails(abn) {
  ...
  try {
    await page.route("**/*", route => {
      ...
      const block = ["image","stylesheet","font","media","websocket","manifest","other"].includes(resourceType);
      if (block || request.url().includes(".css") || request.url().includes(".jpg") || request.url().includes(".png")) {
        route.abort();
